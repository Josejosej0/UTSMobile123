...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextNamaLengkap = findViewById(R.id.Nama);
        ...
        textViewUsia = findViewById(R.id.Usia);
        spinnerJenisKelamin = findViewById(R.id.jenis);
        radioGroupKewarganegaraan = findViewById(R.id.rgroup);
        checkBoxDevelopment = findViewById(R.id.devit);
        checkBoxAI = findViewById(R.id.AIserv);
        checkBoxDesign = findViewById(R.id.DesCre);
        checkBoxWriting = findViewById(R.id.Writ);
        checkBoxFinance = findViewById(R.id.FinAcc);
        editTextEmail = findViewById(R.id.editTextText1);
        buttonReset = findViewById(R.id.resetform);
        buttonSubmit = findViewById(R.id.submitform);
